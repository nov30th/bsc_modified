...
// fourmemeclient is a ZMQ subscriber client for monitoring new Four.meme token creation events
package main
...
// FourMemeTokenMetadata represents the metadata of a Four.meme token
...
var (
	endpoint   = flag.String("endpoint", "tcp://localhost:5557", "ZMQ endpoint to subscribe to")
	topic      = flag.String("topic", "bsc.fourmeme.token.created", "Topic to subscribe to")
...
func main() {
	...
	if !*jsonOutput {
		fmt.Printf("=================================================\n")
		fmt.Printf("  BSC Four.meme Token Monitor Client\n")
		fmt.Printf("=================================================\n")
		fmt.Printf("Endpoint: %s\n", *endpoint)
		fmt.Printf("Topic:    %s\n", *topic)
		fmt.Printf("=================================================\n\n")
		fmt.Println("Waiting for Four.meme token creation events...\n")
	}
	...
	for {
		...
		default:
			...
			// Parse JSON
			var token FourMemeTokenMetadata
...
func printToken(token *FourMemeTokenMetadata, count uint64) {
	timestamp := time.Unix(int64(token.Timestamp), 0)

	fmt.Printf("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
	fmt.Printf("Four.meme Token #%d\n", count)
	fmt.Printf("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n")
